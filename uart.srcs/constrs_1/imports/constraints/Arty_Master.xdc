...
set_property -dict { PACKAGE_PIN E15   IOSTANDARD LVCMOS33 } [get_ports { JB[1] }]; #IO_L12P_T1_MRCC_15 Sch=JB[1]
set_property -dict { PACKAGE_PIN E16   IOSTANDARD LVCMOS33 } [get_ports { JB[2] }]; #IO_L12N_T1_MRCC_15 Sch=JB[2]
set_property -dict { PACKAGE_PIN D15   IOSTANDARD LVCMOS33 } [get_ports { JB[3] }]; #IO_L22N_T3_A16_15 Sch=JB[3]
set_property -dict { PACKAGE_PIN C15   IOSTANDARD LVCMOS33 } [get_ports { JB_C }]; #IO_L23P_T3_FOE_B_15 Sch=JB[4]
#set_property -dict { PACKAGE_PIN J17   IOSTANDARD LVCMOS33 } [get_ports { JB[7] }]; #IO_L23N_T3_FWE_B_15 Sch=JB[7]
#set_property -dict { PACKAGE_PIN J18   IOSTANDARD LVCMOS33 } [get_ports { JB[8] }]; #IO_L24P_T3_RS1_15 Sch=JB[8]
#set_property -dict { PACKAGE_PIN K15   IOSTANDARD LVCMOS33 } [get_ports { JB[9] }]; #IO_L24N_T3_RS0_15 Sch=JB[9]
#set_property -dict { PACKAGE_PIN J15   IOSTANDARD LVCMOS33 } [get_ports { JB[10] }]; #IO_25_15 Sch=JB[10]
...
set_property -dict { PACKAGE_PIN F3    IOSTANDARD LVCMOS33 } [get_ports { JD_C }]; #IO_L13N_T2_MRCC_35 Sch=JD[4]
...
set_property -dict { PACKAGE_PIN V15   IOSTANDARD LVCMOS33 } [get_ports { CK_I }]; #IO_L16P_T2_CSI_B_14 Sch=ck_io[0]
set_property -dict { PACKAGE_PIN U16   IOSTANDARD LVCMOS33 } [get_ports { CK_O }]; #IO_L18P_T2_A12_D28_14 Sch=ck_io[1]
