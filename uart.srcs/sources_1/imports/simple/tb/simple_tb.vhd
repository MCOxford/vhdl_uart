...
-----------------------------------------------------------------------------------------
-- OVERVIEW:
-- Test bench for simple byte source module
-----------------------------------------------------------------------------------------
...
architecture testbench of simple_tb is
    ...
    constant max_count : positive := 1;                                     -- output changes every clock period (DO NOT CHANGE! This is to ensure the test passes)
...
begin
    ...
    begin
        ...
        -- write out bytes to vectors.txt
